...
- First, with the workflow "check_app.yml", it triggers a check to see if the website is online using script "check_website.py"
- Second, with the workflow "wake_up.yml", it calls the site to bring it back online if it was offline, using script "wake_up_streamlit.py"
